...
class EngDFAM extends BlogInfo {
    constructor() {
        super({
            id: 'eng-dfam',
            title: 'Eng DfAM',
            description: 'Studying engineer\'s design behaviors during 3D Printing design tasks',
            date: 'Feb 14 2020',
            tags: ['Matlab', 'UI/UX', 'Machine Learning'],
            cover: Cover,
            card_size: BentoboxSizeOption.Tall,
...
const engDFAMInstance = new EngDFAM();
export default engDFAMInstance;