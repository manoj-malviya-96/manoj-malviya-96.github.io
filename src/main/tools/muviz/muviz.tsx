...
const MuvizApp = () => {
    ...
    const CenterControls = () => (<div className={`flex flex-wrap sm:flex-nowrap w-fit h-fit 
    ...
    const TitleAndDurationRow = () => (
        <div className="flex flex-wrap sm:flex-nowrap justify-between items-center w-full h-full gap-4">
            <span className="text-base sm:text-lg font-bold">{player.title ? player.title : "No Song"}</span>
